...
void test_mt_ledger(){
    printf("mt_ledger test under construction\n");
}
...
/*
  ...
  ledger_setup(&ledger, &pp, fee, tax, close_window, &roger_pk);
  ...
  assert(post(&ledger, mint_str_1) == MT_SUCCESS);
  ...
  assert(post(&ledger, mint_str_2) == MT_SUCCESS);
  ...
  assert(post(&ledger, end_trans_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, int_trans_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, end_esc_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, int_esc_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, reqclose_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, end_close_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, int_close_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, end_cashout_str) == MT_SUCCESS);
  ...
  assert(post(&ledger, int_cashout_str) == MT_SUCCESS);
  ...
  assert(query(&ledger, roger_query_str, &roger_str_out) == MT_SUCCESS);
  ...
  assert(query(&ledger, end_query_str, &end_str_out) == MT_SUCCESS);
  ...
  assert(query(&ledger, int_query_str, &int_str_out) == MT_SUCCESS);
  ...
  assert(query(&ledger, chn_query_str, &chn_str_out) == MT_SUCCESS);
