...
\begin{abstract} {
    ...
    This work is a multi-faceted contribution that includes specification of a novel payment algorithm, analysis of the network integration, and discussion of the economic and social considerations.
