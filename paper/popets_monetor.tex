...
\runningtitle{Scaling Up Anonymous Communication with Efficient Nanopayment Channels}
  ...
  %\subtitle{...}
\begin{abstract}
{Tor, the most widely used and well-studied traffic anonymization network in the
  world, suffers from orthogonal limitations in network diversity and
  ...
  networking implementation. Through live empirical data co-llection and
  analysis of our emulated prototype, we argue that moneTor, based on
  short-lived channels on the top of a long-lived channel, is an elegant and
...
\section{Discussion}
\input{sections/discussion_meta.tex}
