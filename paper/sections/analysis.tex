...
baseline trial with 0\% premium clients. The payment protocols run but the control-flow stays unchanged to only compare the CPU cost of the payment scheme. Since our algorithms makes use of some concurrent crytpographic
