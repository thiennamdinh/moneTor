...
\item Implement a prototype of our nanopayment protocols to extend the Tor protocol
  in the core software, resulting in approximately 15k lines of new code in C; %\op{Add somewhere in the paper a paragraph explaining what is in those 15k lines (everything, but crypto replaced by delays and coin management). }
