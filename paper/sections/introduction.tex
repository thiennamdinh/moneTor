...
\item Discuss economic considerations for the Tor network to favor network
  ...
  %to promote
\item Introduce new highly-efficient nanopayment protocols which overcome the trifecta of constraints \emph{Anonymity}, \emph{Payment Security} and \emph{Efficiency}. Moreover, these protocols may be of some
...
\item Detail our integration strategy to add a payment layer
  which extends the existing Tor architecture but does not modifies it
...
well-studied existing research for all others. On a technical level, we believe that moneTor could be feasibly
developed today within a deployed system such as the Tor network.
