...
\item Discuss economic considerations for the Tor network to favor network
  diversity and to help support Tor as a public good
  %market control such that the Tor project can decide which notion of diversity
  %to promote
\item Introduce new highly-efficient nanopayment protocols which satisfies all
  \emph{Anonymity}, \emph{Payment Security} and \emph{Efficiency}
  constraints. These protocols are formally verified and may be of some independent interest for
