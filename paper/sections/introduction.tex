...
the nontrivial challenge of applying this strategy in light of the following
...
of tokenization. Our goal is to construct an adaptable and
value-agnostic design that shows how incentives can improve Tor.
...
transactions per second without any appreciable issue and achieve optimal
...
graphical results can be found in various repositories at our
Github account~\cite{monetor-github}.
% dwallach Q: double-blind anonymity issues?
