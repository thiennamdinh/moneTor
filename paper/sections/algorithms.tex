...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \Procedure{Intermediary}{$pp, S_I, nS_I$}
      ...
      \State{$nrt_C \gets $Sign$(refund || nT || nwCom_C)$}
      \State{Client.Send$(nrt_C)$}
    \EndProcedure{}

    \Procedure{Client}{}
      \State{$nrt_C \gets $Intermediary.Receive$()$}
      \If{$\neg $Verify$(pk_I, refund||nT||nwCom_C) = 1$}
...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \Procedure{Intermediary}{$pp, S_I, nS_I$}
      ...
      \State{$nrt_R \gets $Sign$(ver, refund || nT || nwCom_R)$}
    \EndProcedure{}
...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \Procedure{Intermediary}{$pp, S_I, nS_I$}
      ...
      \State{$rt'_E \gets $Intermediary.Blindsig$(refund || wCom'_E)$}
