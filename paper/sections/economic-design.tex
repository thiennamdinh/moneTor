...
A key economic question to address is the issue of price
...
information. \op{Maybe a short explanation would be useful here? Not
  sure that I have the reason in mind. Is it because someone who is
  both guard and exit could notice: ``oh, this is they guy who pays
  this unique xyz price for his premium bandwidth'' just by seeing
  that person one day from a guard position, and another day from the exit
  position? } We therefore impose the constraint that all users should
...
\op{Not sure of what is referred to by this ``simple incentive model''}
