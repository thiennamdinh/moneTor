...
We say that $\adv$ is $legal$ if it never agree to execute the Nano-Pay protocol upon $nT = \bot$, and if $\adv$ never asks Tor client to spend more than $n$ payments. We further restrict $\adv$ to establish one nanopayment channel per micropayment channel established with any Tor client. $\adv$ wins if after executions of queries, $bal_\adv > n*\delta$.
