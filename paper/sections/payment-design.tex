...
number of unidirectional nanopayments to the relay through the established Tor circuit. Each payment represents a
...
$t_{i+1}$. The number of available Intermediaries must be a parameter of 
...
discrete random variable holding the number of payment events between any $t_i, t_{i+1}$. 
Moreover, clients 
