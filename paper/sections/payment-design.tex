...
The final consideration is the issue of price determination. While it would be
...
RSCoin~\cite{danezis2015centrally}. This work focuses on payment protocol
designs and evaluation. Therefore, we consider the investigation and choice of
...
% finished, the restrictions that , the assumptions that the commitment scheme
% is secure, the zero-knowledge system is simulation extractable and
