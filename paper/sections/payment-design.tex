...
We argue that a taxation element is necessary to not drift away from the core
mission of the Tor project.
...
of the Tor Project: to advance human rights and freedoms. Inline with this core mission, The Tor Project may for instance desire to compensate
...
taxed income that is anonymously diverted into a shared pool of funds when clients finalize their payments to the relays of their circuit. These
...
RSCoin~\cite{danezis2015centrally}.
...
linkable with eachother but the circuits themselves are not. In this sense, the
...
% to FR: I thought the sentences you added were a bit confusing... here's an
% attempt to improve them but let me know whether it fits what you were going
% for
...
Our current implementation exposes a subtle passive attack by $I$. By examining
