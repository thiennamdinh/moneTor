...
\textit{fungibility}, \textit{divisibility}, \textit{durabililty}, and \textit{transferability}. \flo{We need proper definitions of these properties. In background section or here?}
Furthermore, we
...
\item Small market-cap cryptocurrencies are volatile \flo{I would argue that volatility is not primary linked to the market-cap, but more about the fraction of the market-cap really used within some economy of goods and services. Hence, big market-cap are also highly volatile if any real economy does not sustain the market. This is somewhat what happens now with bitcoin's volatility: the fraction of the market not used in some real economy of goods and services is too high.}
\end{enumerate}
...
Ethereum. \flo{As I said above, I don't think it helps to mitigate volatility}
...
document. \flo{Maybe mention that this price can be decided by the overall network, and can be dynamical? The only constraint is that every Tor users use the *same* price at time *t*}
