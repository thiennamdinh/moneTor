...
tied to tax redistribution, and would be interesting further work, yet the goal 
would be to try to incentive operators with intrinsic motivations to deploy 
more relays, and potentially at more diverse locations (usually costly) if the 
economy generates enough money.
