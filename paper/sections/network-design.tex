...
information in a similar way Tor anticipates the need for a fresh circuit. The effectivness of preemptively established channels is analyzed in Section~\ref{sec:experimentations}, and should make the payment confirmation time to match the round-trip-time of the connection.
