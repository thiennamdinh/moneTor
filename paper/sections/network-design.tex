...
relay would incur an $O(n*m)$ \op{what are $n$ and $m$ here?}  cost with
respect to channel management complexity. By engineering an additional
...
$premium\%s \in [0,100]$, \op{Is this really between 0 and 100 and not
  between 0 and 1?} the fraction of premium to nonpremium clients, we
