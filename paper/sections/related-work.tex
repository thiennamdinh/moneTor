...
\begin{enumerate}
	\item Non-transferable benefits: these proposals aim to recruit relays by offering some
	 privileged status intended for personal use which cannot be securely sold for reimbursement
	  of financial investment.
	\item transferable benefits: these schemes offer
...
non-transferable case.
	\item monetary payments: these schemes offer rewards with what might be considered
