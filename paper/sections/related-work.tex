...
%\paragraph*{Non-transferable benefits - BRAIDS/LIRA}
...
LIRA is an ideological successor to BRAIDS which improves scalability
...
%  (i.e., in moneTor,  frozen funds are independent of the network size).
...
%  \paragraph*{Transferable benefits - TEARS}
...
%% Moreover, websites might not be incentivized to coerce and insert junk traffic,
%% given the impact it could produce on the website rendering, and to its
%% reactivity to user events.
